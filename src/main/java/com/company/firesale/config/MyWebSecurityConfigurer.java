...
public class MyWebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    private void declareSecuredRoutes(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/bids").hasRole("USER")
                .antMatchers(HttpMethod.GET, "/api/conversation/my_conversations/").hasRole("USER")
                .antMatchers(HttpMethod.GET, "/api/conversation/my_conversations").hasRole("USER")
                .antMatchers(HttpMethod.GET, "/api/conversation/id/*").hasRole("USER")
                .antMatchers(HttpMethod.GET, "/api/conversation/with/*/").hasRole("USER")
                .antMatchers(HttpMethod.GET, "/api/conversation/with/*").hasRole("USER")
                .antMatchers("/app/chat.sendMessage").hasAnyRole("USER", "ADMIN")
